...
const ROUTES: Route[] = [
  {
    ...
    priority: 1,
    sources: ["src/app/(marketing)/[lang]/page.tsx", "src/components/landing", "src/lib/language.tsx"],
  },
  {
    path: "/pricing",
    ...
    priority: 0.9,
    sources: [
      "src/app/(marketing)/[lang]/pricing/page.tsx",
  ...
  },
  {
    ...
    priority: 0.9,
    sources: [
      "src/app/(marketing)/[lang]/build-cv/page.tsx",
  ...
  },
  {
    ...
    changeFrequency: "monthly",
    priority: 0.8,
    sources: ["src/app/(marketing)/[lang]/questions/page.tsx", "src/components/questions", "src/lib/language.tsx"],
  },
  {
    path: "/guides",
    changeFrequency: "yearly",
    priority: 0.7,
    sources: ["src/app/(marketing)/[lang]/guides/page.tsx", "src/components/guides", "src/lib/language.tsx"],
  },
  {
    path: "/about",
    changeFrequency: "yearly",
    priority: 0.6,
    sources: ["src/app/(marketing)/[lang]/about/page.tsx", "src/components/about", "src/lib/language.tsx"],
  },
  {
    path: "/terms",
    changeFrequency: "yearly",
    priority: 0.3,
    sources: ["src/app/(marketing)/[lang]/terms/page.tsx", ...LEGAL_SOURCES],
  },
  {
    path: "/privacy",
    changeFrequency: "yearly",
    priority: 0.3,
    sources: ["src/app/(marketing)/[lang]/privacy/page.tsx", ...LEGAL_SOURCES],
  },
  {
    path: "/security",
    changeFrequency: "yearly",
    priority: 0.3,
    sources: ["src/app/(marketing)/[lang]/security/page.tsx", ...LEGAL_SOURCES],
  },
  {
    path: "/refund-policy",
    changeFrequency: "yearly",
    priority: 0.3,
    sources: ["src/app/(marketing)/[lang]/refund-policy/page.tsx", ...LEGAL_SOURCES],
  },
];
