...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      // Was missing here (present on every other route) — the homepage,
      // the page people actually share, had no og:image on Facebook,
      // LinkedIn or WhatsApp, only a twitter:image. Fixed in passing while
      // wiring in the Arabic card.
      images: [ogImage(lang)],
    },
    twitter: {
