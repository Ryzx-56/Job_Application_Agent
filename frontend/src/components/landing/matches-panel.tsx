...
export function MatchesPanel() {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex flex-wrap items-center justify-between gap-x-5 gap-y-2 px-5 py-4 sm:px-7"
      ...
      <ul className="m-0 list-none p-0">
        {items.map((item, i) => (
          <li
            key={item.role}
            className="scan-row flex items-center gap-3 px-5 py-3.5 sm:gap-4 sm:px-7"
            style={{
