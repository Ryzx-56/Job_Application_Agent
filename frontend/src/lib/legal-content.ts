    ...
    terms: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            "Tarshih uses artificial intelligence, including third-party AI models from providers such as OpenAI and Google (Gemini), to help you create, upgrade, and tailor resumes (CVs) and cover letters against specific job descriptions, in English or Arabic, and to surface related job postings and applicant tracking system (ATS) and job-match scoring for informational purposes.",
        ...
        },
        {
          ...
          body: [
            "Delivering the Service relies on third-party providers, including AI model providers (currently OpenAI and Google Gemini) and search providers used to tailor documents and surface similar jobs, an authentication and database provider, and a licensed third-party payment provider that processes card payments made through the Service on our behalf. These providers process data on our behalf under their own terms and, where applicable, data processing agreements, as described further in our Privacy Policy. We select providers with appropriate safeguards but are not responsible for outages or failures caused solely by a third-party provider outside our control.",
          ],
        },
        {
          heading: "12. Privacy",
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "• AI model providers (currently OpenAI and Google Gemini) and search providers, to parse your CV and job description, tailor your resume and cover letter, calculate scores, and find similar jobs. Relevant content from Your Content is sent to these providers solely to generate the output you requested.",
    ...
    security: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            "When your CV or a job description is tailored, relevant content is sent to third-party AI providers (currently OpenAI and Google Gemini) over encrypted connections solely to generate your requested output. This is described in more detail in our Privacy Policy.",
          ],
        },
        {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "نحن لا نستخدم محتواك لتدريب نماذج ذكاء اصطناعي أساسية خاصة بنا. تتم معالجة المحتوى المُرسَل إلى مزودي الذكاء الاصطناعي من أطراف ثالثة (حاليًا OpenAI و Google Gemini) بموجب شروط واجهة برمجة التطبيقات الخاصة بهم بهدف توليد المخرجات التي طلبتها؛ ونحن لا نأذن لهؤلاء المزودين باستخدامه لتدريب نماذج تخدم عملاء آخرين، بالقدر الذي تسمح لنا شروطهم التجارية الخاصة بذلك.",
          ],
        },
        {
          ...
          body: [
            ...
            "• مزودو نماذج الذكاء الاصطناعي (حاليًا OpenAI و Google Gemini) ومزودو البحث، لتحليل سيرتك الذاتية ووصفك الوظيفي وتخصيص مستنداتك وتوليد خطابات التقديم وحساب النتائج وإيجاد وظائف مشابهة. يُرسَل المحتوى ذو الصلة من محتواك إلى هؤلاء المزودين فقط لتوليد المخرجات التي طلبتها.",
    ...
    security: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: ["عند تخصيص سيرتك الذاتية أو وصف وظيفي، يُرسَل المحتوى ذو الصلة إلى مزودي ذكاء اصطناعي من أطراف ثالثة (حاليًا OpenAI و Google Gemini) عبر اتصالات مشفّرة فقط لتوليد المخرجات التي طلبتها. مزيد من التفاصيل موضح في سياسة الخصوصية."],
        },
        {
